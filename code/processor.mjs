...
function singleModeInit(stats,pool){
	assignConfiguration(stats,pool)
}
function singleMode(){
  console.log('single mode active')
}
function multiModeInit(stats,pool){
	assignConfiguration(stats,pool)
}
...
export default{assignConfiguration,singleModeInit,singleMode,multiModeInit,multiMode}